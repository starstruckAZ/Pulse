...
import {
  ...
  User, Share2, Check, Flame, Trophy, Zap, Search, CheckCircle,
} from "lucide-react";
...
export default function DashboardClient({
  ...
  streak = 0, xp = 0, totalResponses = 0, hasGoogle = false,
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        {/* Connect CTA */}
        {locations.length === 0 && (
          <div className="bento mb-8 p-8">
            {!hasGoogle ? (
              /* Step 1: Connect Google account */
              <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
                <div>
                  <h2 className="mb-1 font-display text-lg font-bold">Connect your Google account</h2>
                  <p className="text-sm text-zinc-400">Link Google to verify business ownership and claim your listing securely.</p>
                  <div className="mt-2 flex items-center gap-1.5 text-xs text-zinc-500">
                    <span className="flex h-4 w-4 items-center justify-center rounded-full bg-zinc-700 text-[10px] font-bold text-white">1</span>
                    Connect Google
                    <span className="text-zinc-700">→</span>
                    <span className="flex h-4 w-4 items-center justify-center rounded-full bg-zinc-800 text-[10px] font-bold text-zinc-500">2</span>
                    Find your business
                    <span className="text-zinc-700">→</span>
                    <span className="flex h-4 w-4 items-center justify-center rounded-full bg-zinc-800 text-[10px] font-bold text-zinc-500">3</span>
                    Claim it
                  </div>
                </div>
                <button
                  onClick={handleConnectGoogle}
                  className="btn-ghost inline-flex shrink-0 items-center gap-2.5 rounded-2xl border border-white/[0.08] px-6 py-3 text-sm font-medium"
                >
              ...
              /* Step 2: Google connected — now find & claim business */
              <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
                <div>
                  ...
                  <h2 className="font-display text-lg font-bold">Find and claim your business</h2>
                  <p className="text-sm text-zinc-400">Search for your business, then click Claim to link it to your account.</p>
                </div>
                <div className="flex shrink-0 items-center gap-2">
                  <Link href="/search" className="btn-primary inline-flex items-center gap-2 rounded-2xl px-6 py-3 text-sm">
                    <Search className="h-4 w-4" /> Search Your Business
                  </Link>
                  <Link href="/dashboard/locations" className="btn-ghost inline-flex items-center gap-2 rounded-2xl border border-white/[0.08] px-4 py-3 text-sm">
                    <MapPin className="h-4 w-4" /> Add Manually
                  </Link>
                </div>
              </div>
            )}
